              ...
              >
                <button
                  ...
                  className={`
                    ...
                    ${isActive ? 'bg-sky-500/20 border-sky-400/50 shadow-lg shadow-sky-500/20' : 'bg-white/5 border-white/10 hover:bg-white/10 hover:border-white/20'}
                ...
                >
                  <Icon
                    ...
                    className={isActive ? 'text-sky-300' : 'text-white'}
                  />
                  <span className={`absolute -bottom-1 w-1.5 h-1.5 rounded-full ${isActive ? 'bg-sky-400' : 'bg-transparent'}`} />
                </button>
